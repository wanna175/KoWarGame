...
// ********************************************************************
// * 구조체명: _RequestLoadObjInfoPacket
...
// ********************************************************************
// * 구조체명: _ResponseLoadObjInfoPacket
...
public:
    ...
    //로그인 및 초기 연결 관련 패킷
    static void CreateRequestLoginPacket(int32_t nClinetFd, struct _Packet* pStrtPacket);
    static void CreateResponseLoginPacket(int32_t nClinetFd, struct _Packet *pStrtPacket);
    ...
    static void CreateResponseLoadMilitaryUnitPacket(int32_t nThisFd, int32_t nClientFd,int8_t nIsFinFlag, CMilitaryUnit *pStrtMilitaryUnit, StResponseLoadMilitaryUnitInfoPacket *pStrtPacket);
    ...
    static void CreateResponseOrderInSallyPacket(int32_t nThisFd, int32_t nClientFd, CMilitaryUnit *pStrtMilitaryUnit, CArtillery *pStrtArtillery, StResponseOrderInSallyPacket *pStrtPacket);
    static void CreateRequestOrderInAttackPacket(int32_t nThisFd, int32_t nClientFd, int16_t nArtilleryId, int32_t nDstX, int32_t nDstY, StRequestOrderInAttackPacket *pStrtPacket);
    static void CreateResponseOrderInAttackPacket(int32_t nThisFd, int32_t nClientFd, CArtillery *pStrtArtillery, CMissile *pStrtMissile, StResponseOrderInAttackPacket *pStrtPacket);

    static void CreateSyncArtilleryCoordinatePacket(int32_t nThisFd, int32_t nClientFd, bool_t bIsArrived, CArtillery *pStrtArtillery, StSyncArtilleryCoordinatePacket *pStrtPacket);
    static void CreateSyncMissileCoordinatePacket(int32_t nThisFd, int32_t nClientFd, bool_t bIsArrived, CMissile *pStrtMissile, StSyncMissileCoordinatePacket *pStrtPacket);
    static void CreateSyncArtilleryAttackedPacket(int32_t nThisFd, int32_t nClientFd, CArtillery *pStrtArtillery, StSyncArtilleryAttackedPacket *pStrtPacket);
    static void CreateSyncMilitaryUnitAttackedPacket(int32_t nThisFd, int32_t nClientFd, CMilitaryUnit *pStrtMilitaryUnit, StSyncMilitaryUnitAttackedPacket *pStrtPacket);
    static void CreateSyncSimulationTimePacket(double_t nCurrentSimulationTime, StSyncSimulationTimePacket *pStrtPacket);

    //Database server와 통신
    static void CreateRequestLoadMilitaryUnitFromDB(StRequestLoadMilitaryUnitInfoFromDBPacket *pPacket);
    static void CreateResponseLoadMilitaryUnitFromDB(StResponseLoadMilitaryUnitInfoFromDBPacket *pPacket);
};
}