...
namespace DATATRSFER {
    ...
    */
    ...
    {
        ADMIN_ID            = 0,     //client가 관리하는 부대정보가 없음
...
#pragma pack(push, 1)
 ...
 // ********************************************************************
    ...
    typedef struct _ResponseOrderInAttackPacket {
        StPacketHeader        strtHeader;
        int32_t               nUserClientFd;          //클라이언트를 식별하기 위함.
        StArtilleryPacketInfo strtArtilleryInfo;      //updated 자주포정보
...
// * 설    명: missile 객체의 위치값 동기화 패킷을 정의
// * 작 성 자: KJH
// * 작성날짜: 2025. 09. 08
// ********************************************************************
    typedef struct _SyncMissileCoordinatePacket {
        StPacketHeader        strtHeader;
        int32_t               nUserClientFd;          //클라이언트를 식별하기 위함.
        StMissilePacketInfo strtMissileInfo;      //자주포정보
...
// ********************************************************************
    ...
    public:
        ...
        //로그인 및 초기 연결 관련 패킷
        static void CreateRequestLoginPacket(const char_t* strUserId, const char_t* strUserPW, StLoginRequestPacketData* pStrtPacket);
